...
For now, let's assume an "optimal capabilities" AI — (again, we'll tackle sub-optimal AIs later) — that can predict the world perfectly. And since _you're_ part of the world, it can predict _how you'd react to various outcomes_ perfectly.
