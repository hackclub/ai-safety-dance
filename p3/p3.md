...
( What about _intelligent_ adversaries, who can steer & navigate through the holes? Look, it's a metaphor. The "multiple imperfect layers of defense" model works even against intelligent adversaries. Cybersecurity is a good example: this is why, for important online accounts, you need a password _and_ multifactor authentication code.)
...
It's important to not take the cheese metaphor too literally. The "multiple imperfect layers of defense" model works even against intelligent adversaries. Cybersecurity is a good example: this is why, for important online accounts, you need a password _and_ multifactor authentication code.
